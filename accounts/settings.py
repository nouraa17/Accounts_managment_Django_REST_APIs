...
IMAGE_MODEL = keras.models.load_model(
    r'E:\FCIH\Level 4\GP\Django\newone\implant_model.h5')
# IMAGE_MODEL = YOLO(
...
SECRET_KEY = 'django-insecure-tv)oihfknxf%bn6fluqq0-tx(m@d^)ez=7hkqo4u+=2lqdxw^6'
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'implants')
MEDIA_URL = '/implants/'
